...
export class AdminUsersComponent implements OnInit {
  ...
  private normalizarModulos(rol: string, modulos: AppModuleKey[] | string[] = []): AppModuleKey[] {
    const modules = this.adminUsers()?.modules ?? [
      ...
      { key: 'estadisticas' as AppModuleKey, label: 'Estadisticas' },
      ...
      { key: 'acuerdos-estadisticas' as AppModuleKey, label: 'Estadisticas acuerdos' },
      { key: 'acuerdos-valores' as AppModuleKey, label: 'Valores de ubicaciones' },
